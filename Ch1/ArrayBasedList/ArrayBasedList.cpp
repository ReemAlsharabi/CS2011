...
int ArrayBasedList::size()
{
	return s;
}
string ArrayBasedList::get(int i)
{
	return a[i];
}
void ArrayBasedList::set(int i, string x)
{
	a[i] = x;
}
void ArrayBasedList::add(int i, string x)
{
	if (s == 10)
...
string ArrayBasedList::remove(int i)
{
